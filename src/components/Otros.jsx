      ...
      <section className="bg-white dark:bg-gray-900">
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Plan Idiomas</h3>
          ...
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Plan Tandem</h3>
          ...
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Quiero Contribuir</h3>
          ...
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Plan Empresas</h3>
